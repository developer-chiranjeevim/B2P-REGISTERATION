...
const FormContainer: React.FC = () => {
    ...
    const upload_file = async(file: File, presigned_url: string) => {
        try{
            ...
            const response = await axios.put(presigned_url, file, {
                headers: {
    ...
    const onSubmit = async(values: FormValuesIF, actions: FormikHelpers<FormValuesIF>) => {
        ...
        if (values.resume && resume_url) {
            upload_file(values.resume, resume_url);
        }
                            ...
                            <Form className="grid grid-cols-1 md:grid-cols-2 gap-[4rem] my-[2rem]">
                                <div className="col-span-1">
                                    ...
                                    <div className="grid grid-cols-4 gap-[1rem] mb-[2rem]">
                                        ...
                                        <div className="col-span-4 lg:col-span-3">
                                            <Field as="select" id="car-brand" name="qualification" className="w-full border-[1px] text-gray-500 border-gray-300 py-[0.5rem] px-[1rem] rounded-md focus:outline-none">
                                    ...
                                    <div className="grid grid-cols-4 gap-[1rem] mb-[2rem]">
                                        ...
                                        <div className="col-span-4 lg:col-span-3">
                                            <Field as="select" id="car-brand" name="major" className="w-full border-[1px] text-gray-500 border-gray-300 py-[0.5rem] px-[1rem] rounded-md focus:outline-none">
                                ...
                                <div className="flex items-center gap-[1rem]">
                                    <button type="submit" className="cursor-pointer bg-green-600 text-white cpaitalize px-[2rem] py-[0.75rem] rounded-lg capitalize font-semibold hover:bg-green-700 duration-300">submit</button>
                                    <button 
                                        type="button" 
                                        onClick={() => {
                                            resetForm();
